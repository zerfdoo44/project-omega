...
// Railway needs a port to be "listening" to keep the app healthy.
void healthCheck() {
    ...
    // Railway uses a PORT environment variable, but 5000 is a safe bet.
...
void clearScreen() {
    // Standard clear for Linux (Railway)
...
bool isTargetTime() {
    ...
    // TARGET: Dec 31, 2025 at 23:59:50
